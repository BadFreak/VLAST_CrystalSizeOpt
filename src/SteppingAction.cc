...
//void SteppingAction::UserSteppingAction(const G4Step* aStep, const std::string& yamlFile)
{
	//YAML::Node config  = YAML::LoadFile(yamlFile);
	//const int arraysize = config["crystalArraySize"].as<int>;
	//const int crystalz = config["crystalLength"].as<double>;
	const int arraysize = 5;
	const double crystalz = 20;
	...
	if(volumeName=="Crystal") {  fEventAction_Step->AddCrystalEnDep(copyNo,edep,arraysize, crystalz); }
